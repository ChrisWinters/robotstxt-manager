 ...
 * @call new RobotstxtManager_Robotstxt();
 * 
 * @method __construct()    Check File Being Called
 * @method robotstxt()      Display Robots.txt File
 */
if ( ! class_exists( 'RobotstxtManager_Robotstxt' ) )
{
    class RobotstxtManager_Robotstxt
    {
        /**
        ...
        final private function robotstxt()
        {
            ...
            if( get_option( 'robotstxt_manager_status' ) ) {
                ...
                $website_robotstxt = get_option( 'robotstxt_manager_robotstxt' );
